...
public class Parser_backup {
	...
	*/
	...
	private static void xmlRemoveAllTask(Node node) {
	 ...
	 /*=============================== HashMap ==============================*/
	//Not in used
	 private Task searchTaskFromHashMap(HashMap<Integer, Task> mMap, int id){		 
		 Task searchTask = mMap.get(id);
		 return searchTask;
	 }
	 
	//Not in used
	 private Task searchTaskFromHashMap(HashMap<Integer, Task> mMap, String title){
	 ...
	 private Task searchTaskFromHashMap(HashMap<Integer, Task> mMap, String start_ms, String end_ms){
	 ...
	 private Task searchTaskFromHashMap(HashMap<Integer, Task> mMap, boolean mIsDone){
